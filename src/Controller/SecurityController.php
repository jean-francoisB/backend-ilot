...
class SecurityController extends AbstractController
{
    ...
    #[Route(path: '/nounou', name: 'app_nounou')]
    public function nounou(AuthenticationUtils $authenticationUtils): Response
    {
        // if ($this->getUser()) {
        //     return $this->redirectToRoute('target_path');
        // }
    ...
    public function logout(TokenStorageInterface $tokenStorage): JsonResponse
    {
        ...
        // return $this->render('security/login.html.twig', ['last_username' => $user->getNom(), 'error' => $error]);
